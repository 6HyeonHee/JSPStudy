...
<body>
	...
	즉 requestScoope.personObj.name 형태로 기술하지 않아도 된다.
	...
	// 따라서 영역에서 꺼낸 후 원래의 타입으로 형변환해야한다.
	...
	<ul>
		...
		따라서 산술연산을 위해서는 반드시 숫자형식으로 변환 후 진행해야한다.
		하지만 EL에서는 자동으로 숫자형식으로 변환되므로 아래와 같이 즉시
		연산할 수 있다.  -->
