...
: 국가별로 다양한 언어, 날짜, 간, 숫자형식을 설정할 때 사용한다.
접두어는 fmt를 사용한다.
 -->
<body>
	<h4>숫자 포맷 설정</h4>
	...
	<!-- 
	groupingUsed : 세자리마다 콤마를 출력한다. 디폴트값이 true이므로 콤마를
				출력하고, 싶지 않다면 false를 지정한다.
	 -->
