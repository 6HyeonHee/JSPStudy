...
<body>
	...
	<!-- 저장 순서대로 Person 인스턴스를 변수 list에 저장 후 getter를 통해
	멤버변수에 저장된 값을 출력한다. -->
	<li>
	...
	<%
	/*
	Map 계열의 컬렉션을 생성한다 Key는 String, Value는 Person타입으로 지정.
	*/
	...
	<!-- 
	Map 사용 시 Key를 별도로 얻어올 필요없이 변수명.key 혹은 변수명.vlaue를 통해
	값을 얻어와 출력할 수 있다.
	 -->
	...
	for(String key : keys) {
		...
		/*
		Key와 Value를 출력한다. Value는 Person인스턴스 이므로 멤버변수에 저장된
		값을 getter통해 출력할 수 있다.
		*/
	...
	/*
	JSTL 확장 for문을 사용하면 Key를 별도로 얻어와야 하는 번거로움이 없으므로
	편리하다.
