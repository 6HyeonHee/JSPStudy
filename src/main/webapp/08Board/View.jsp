...
function deletePost() {
    ...
    if (confirmed) {
        ...
        form.submit();
        // 그러면 <form> 태그에 설정해 둔 일련번호(num)가 서버로 전송된다.
    }
}
</script>
</head>
...
<!-- 
게시물을 삭제할 때 JavaScript를 통해 submit(전송)하기 위해 <form> 태그를 
...
<input type="hid-den" name="num" value="<%= num %>" />  
    ...
    <table border="1" width="90%">
        ...
        <tr>
            ...
            <%
            /*
            로그인이 된 상태에서 세션 영역에 저장된 아이디가 해당 게시물을 작성한
            아이디와 일치하면 수정/삭제 버튼을 보이게 처리한다.
            즉, 작성자 본인이 해당 게시물을 조회했을때만 버튼이 보이게 된다.
            로그인 하지 않은 사용자가 진입하는 경우 첫번재 조건에 만족하지 않으므로
