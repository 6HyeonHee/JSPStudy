...
/*
 ...
 2. 클라이언트의 요청을 받아 처리하기 위한 doGet()/doPost()를
 오버라이딩 한다.
 3. 서블릿에 필수적인 패키지 임포트와 예외처리는 자동으로 완성된다.
 4. request 내장객체과 response 내장객체는 매개변수를 통해 서블릿에 이미 포함되어 있다.
*/
public class HelloServlet extends HttpServlet {
	/*
	 서블릿 작성 시 발생되는 경고(Warning)를 위해 추가한다.
